...
/**
 * Einheitlicher Abschnittskopf: links ausgerichtet, ab lg zweispaltig – Titel
 * links, Fließtext rechts auf der Grundlinie. `centered` für den Kontakt, wo
 * Zentrierung als Call-to-Action richtig ist.
 */
const SectionHeader = ({
    command,
    argument,
