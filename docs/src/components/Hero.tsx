...
const Hero = () => {
    return (
        ...
        <section className="relative min-h-screen w-full overflow-x-clip bg-gradient-to-br from-[#1a0b2e] via-[#2d1b4e] to-[#1a0b2e]">
            ...
            >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-[#1a0b2e]/90 via-transparent to-[#1a0b2e]/90" />
                <div className="absolute inset-0 bg-gradient-to-b from-[#1a0b2e]/40 via-transparent to-[#1a0b2e]/60" />
            </motion.div>

            {/* Content Grid */}
            <div className="relative z-10 grid min-h-screen lg:grid-cols-2">

                {/* Left Side - Mit krasser Animation */}
                <div className="flex items-center px-8 py-20 lg:px-16">
                    <div className="max-w-xl">
                        ...
                        <div className="mb-6 overflow-hidden">
                            ...
                            <motion.div
                                className="bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 bg-clip-text text-7xl font-bold leading-none tracking-tight text-transparent lg:text-8xl xl:text-9xl"
                        ...
                        >
                            <Button
                                size="lg"
                                className="rounded-full bg-gradient-to-r from-pink-500 to-purple-600 px-8 py-6 text-lg font-semibold text-white transition-all hover:scale-105 hover:from-pink-600 hover:to-purple-700 hover:shadow-[0_0_30px_rgba(236,72,153,0.5)]"
                            >
                                Let's Connect
                            </Button>
                ...
                <div className="flex items-center justify-end px-8 py-20 lg:px-16">
                    <div className="space-y-4 max-w-sm">
                        ...
                        {/* Card 1 */}
                        <div
                            className="group rounded-xl border border-purple-500/20 bg-purple-950/30 p-4 backdrop-blur-sm transition-all duration-300 hover:border-purple-500/40 hover:bg-purple-900/30 hover:translate-x-[-8px] hover:scale-[1.02]"
                            style={{
                                animation: 'slideInFromRight 0.6s linear 1.4s both'
                            }}
                        >
                            <div className="flex items-center gap-3">
                                <div className="rounded-lg bg-gradient-to-br from-cyan-500 to-blue-600 p-2 transition-transform duration-500 group-hover:rotate-[360deg]">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className="rounded-lg bg-gradient-to-br from-pink-500 to-purple-600 p-2 transition-transform duration-500 group-hover:rotate-[360deg]">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className="rounded-lg bg-gradient-to-br from-purple-500 to-pink-600 p-2 transition-transform duration-500 group-hover:rotate-[360deg]">
